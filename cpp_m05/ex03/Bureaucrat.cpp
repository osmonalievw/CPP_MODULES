...
Bureaucrat::Bureaucrat(std::string const &arg_name, int arg_grade) : _name(arg_name)
{
    ...
    std::cout << "Bureaucrat Parameter Constructor called for " << this->_name << std::endl;
}
...
Bureaucrat::~Bureaucrat() { std::cout << "Bureaucrat Destructor called for " << this->_name << std::endl; }
